...
export default function Samtaler() {
  return (
    <section id="Samtaler" className="p-4 mt-24">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md lg:h-max lg:scale-105 z-10 translate-y-0">
            <div className="p-6 text-center">
              ...
              <img src="/Parterapi.jpg" alt="" className="rounded-xl pt-8" />
          ...
          <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md lg:h-max lg:scale-105 z-10 translate-y-0">
            <div className="p-6 text-center">
              ...
              <img src="/TerapiOnline.png" alt="" className="rounded-xl pt-8" />
