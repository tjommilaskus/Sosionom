  ...
  return (
    ...
    >
      ...
      <ul className="pt-5 max-w-md space-y-1 text-gray-600 list-disc list-insid">
        ...
        <li>Kurs i HMS</li>
        <li>Kurs i Motiverende intervju</li>
        <li>Kurs i Rus og avhengighet</li>
      </ul>
      ...
      <div className="lg:flex p-2">
        <p className="text-sm p-3 text-gray-600">
          ...
          roller som både lærer og assistent i utdanningssektoren, hvor han
          underviste både individuelle studenter og grupper. I tillegg har
