  ...
  const courses = [
    {
      ...
      price: "590 kr/t",
      additionalCost: ["Kjøring, rapportskriving og", <br key="br4" />, "deltakelse i møter er", <br/>, "inkludert i prosen"],
      features: [
    ...
    },
    {
      ...
      price: "590 kr/t",
      additionalCost: ["Kjøring, rapportskriving og", <br key="br5" />, "deltakelse i møter er", <br/>, "inkludert i prosen"],
      features: [
        "Målrettet mijøterapi",
        "Aktivisering",
        "Kartlegging",
