  ...
  return (
    <section className="bg-[#ffd15a]" id="kontaktoss">
      <div className=" inset-0 flex flex-col justify-center items-center w-full  text-center relative mt-14">
        <h2 className="text-xl pt-5  text-gray-800 mt-24 font-bold mb-3">
          Kontakt oss
        </h2>
        <div className="pt-2 border border-black">
          <a href="/" className="text-gray-900">
            <Image src={Logo} alt="logo" width={200} height={200} />
          </a>
        </div>
        <div className="py-5 text-gray-700">
          <p className="text-gray-900">🏢 Lørenvangen 21A, 0585 Oslo</p>
